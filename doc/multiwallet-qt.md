...
In order to support loading of multiple wallets in dystem-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dystem.cpp.
...
Changes to dystem.cpp
----------------------
dystem.cpp is the entry point into dystem-qt, and as such, will require some minor modifications to provide hooks for
