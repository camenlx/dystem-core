Contributing to Dystem Core
==================================

The Dystem Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dystem Core project, and is not to be
confused with overall Dystem Network Protocol consensus changes.

Whether a pull request is merged into Dystem Core rests with the project merge
...
Patches that change Dystem consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dystem consensus, it must have been
...
The project leader is the release manager for each Dystem Core release.
