    ...
    if (strCommand == "mnget") { //Masternode Payments Request Sync
        ...
        if (Params().NetworkID() == CBaseChainParams::MAIN) {
            if (pfrom->HasFulfilledRequest("mnget")) {
                ...
                Misbehaving(pfrom->GetId(), 20, _("masternode-payments:ProcessMessageMasternodePayments::InvalidBlockFound"));
                return;
            }
        }
        ...
        if (!winner.SignatureValid()) {
            ...
            if (masternodeSync.IsSynced()) Misbehaving(pfrom->GetId(), 20, _("masternode-payments:ProcessMessageMasternodePayments::InvalidBlockFound"));
