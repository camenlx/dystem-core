...
/* Dystem GUI -- Size of icons in status bar */
...
#define COLOR_UNCONFIRMED QColor(76, 117, 161)
/* Transaction list -- negative amount */
#define COLOR_NEGATIVE QColor(245, 171, 171)
// #define 
...
/* Transaction list -- TX status decoration - default color */
#define COLOR_INPUT QColor(171, 245, 171)
//#define COLOR_INPUT QColor(245, 245, 171)
/* Transaction list -- TX status decoration - conflicted */
#define COLOR_CONFLICTED QColor(245, 0, 245)
/* Transaction list -- TX status decoration - orphan (Light Gray #D3D3D3) */
#define COLOR_ORPHAN QColor(245, 171, 245)
/* Transaction list -- TX status decoration - stake (BlueViolet #8A2BE2) */
#define COLOR_STAKE QColor(245, 245, 171)
