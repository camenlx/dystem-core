...
/** Utility functions used by the DYSTEM Qt UI.
 */
namespace GUIUtil
{
...
// Render DYSTEM addresses in monospace font
...
// Parse "dystem:" URI into recipient object, return true on successful parsing
