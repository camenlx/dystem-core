                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(960, 682), this);

    QString windowTitle = tr("Dystem Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    overviewAction->setStatusTip(tr("Balance and Transaction overview"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a dystem address"));
    ...
    QIcon receiveIcon;
    receiveIcon.addFile(":/icons/receiving_addresses",QSize(40,40),QIcon::Normal,QIcon::On);
    receiveIcon.addFile(":/icons/receiving_addresses_off",QSize(40,40),QIcon::Normal,QIcon::Off);
    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dystem: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dystem Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dystem Core"));
...
*/
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dystem"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dystem addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dystem addresses"));
    ...
    openAction->setStatusTip(tr("Open a Dystem: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dystem Core help message to get a list with possible DYSTEM command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        for(int i = 0; i < lay->count(); ++i)
            lay->itemAt(i)->setAlignment(Qt::AlignHCenter);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dystem Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dystem network", "", count));
}
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::UnlockedForStakingOnly:
        labelEncryptionIcon->show();
        if( previousLockState == WalletModel::UnlockedForStakingOnly ) {
