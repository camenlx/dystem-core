                                                  ...
                                                  walletModel(0)
{
    ...
    int columnpubKey = 130;

    ui->tableWidgetCommissions->setAlternatingRowColors(true);
    ui->tableWidgetCommissions->setColumnWidth(0, columnAliasWidth);
    ui->tableWidgetCommissions->setColumnWidth(1, columnAddressWidth);
    ui->tableWidgetCommissions->setColumnWidth(2, columnProtocolWidth);
    ui->tableWidgetCommissions->setColumnWidth(3, columnStatusWidth);
    ui->tableWidgetCommissions->setColumnWidth(4, columnActiveWidth);
    ui->tableWidgetCommissions->setColumnWidth(5, columnLastSeenWidth);
    ui->tableWidgetCommissions->setColumnWidth(6, columnpubKey);
    ...
    connect(ui->tableWidgetCommissions, SIGNAL(customContextMenuRequested(const QPoint&)), this, SLOT(showContextMenu(const QPoint&)));
...
void IdentSettings::showContextMenu(const QPoint& point)
{
    QTableWidgetItem* item = ui->tableWidgetCommissions->itemAt(point);
    if (item) contextMenu->exec(QCursor::pos());
}

void IdentSettings::StartAlias(std::string strAlias)
{
...
void IdentSettings::StartAll(std::string strCommand)
{
...
void IdentSettings::updateMyMasternodeInfo(QString strAlias, QString strAddr, CMasternode* pmn)
{
...
void IdentSettings::updateMyNodeList(bool fForce)
{
...
void IdentSettings::on_startButton_clicked()
{
    // Find selected node alias
    QItemSelectionModel* selectionModel = ui->tableWidgetCommissions->selectionModel();
    ...
    std::string strAlias = ui->tableWidgetCommissions->item(nSelectedRow, 0)->text().toStdString();
...
void IdentSettings::on_startAllButton_clicked()
{
    // Display message box
...
void IdentSettings::on_startMissingButton_clicked()
{
...
void IdentSettings::on_tableWidgetMyMasternodes_itemSelectionChanged()
{
...
void IdentSettings::on_UpdateButton_clicked()
{
    updateMyNodeList(true);
}
