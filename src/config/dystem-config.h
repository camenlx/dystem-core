/* src/config/dystem-config.h.  Generated from dystem-config.h.in by configure.  */
/* src/config/dystem-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DTEM_CONFIG_H

#define DTEM_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.dystem.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Dystem Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Dystem Core 1.0.5"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dystem"
