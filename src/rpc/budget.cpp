...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a DTEM initiative\n"
            "  vote-alias         - Vote on a DTEM initiative\n"
            "  vote               - Vote on a DTEM initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"dtem-address\" monthy-payment\n"
            ...
            "5. \"dtem-address\":   (string, required) DTEM address to send payments to\n"
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"dtem-address\" monthy-payment \"fee-tx\"\n"
