...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DYSTEM features */
        {"dystem", "masternode", &masternode, true, true, false},
        {"dystem", "listmasternodes", &listmasternodes, true, true, false},
        {"dystem", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dystem", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dystem", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dystem", "masternodedebug", &masternodedebug, true, true, false},
        {"dystem", "startmasternode", &startmasternode, true, true, false},
        {"dystem", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dystem", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dystem", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dystem", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dystem", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dystem", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dystem", "mnbudget", &mnbudget, true, true, false},
        {"dystem", "preparebudget", &preparebudget, true, true, false},
        {"dystem", "submitbudget", &submitbudget, true, true, false},
        {"dystem", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dystem", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dystem", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dystem", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dystem", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dystem", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dystem", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dystem", "checkbudgets", &checkbudgets, true, true, false},
        {"dystem", "mnsync", &mnsync, true, true, false},
        {"dystem", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> dystem-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:65445/\n";
}
