...
/**
 * Fees smaller than this (in udtem) are considered zero fee (for transaction creation)
...
bool CWallet::AddToWallet(const CWalletTx& wtxIn, bool fFromLoadWallet)
{
    ...
    if (fFromLoadWallet) {
        ...
        //// debug print
        LogPrint("net","AddToWallet %s  %s%s\n", wtxIn.GetHash().ToString(), (fInsertedNew ? "new" : ""), (fUpdated ? "update" : ""));
            ...
            while (true) {
                ...
                if (!SelectCoins(nTotalValue, setCoins, nValueIn, coinControl, coin_type, useIX)) {
                    if (coin_type == ALL_COINS) {
                        ...
                        strFailReason = _("Unable to locate enough funds for this transaction that are not equal 5000 DTEM.");
                    }
                ...
                if (nChange > 0) {
                    ...
                    // change transaction isn't always pay-to-dystem-address
                    CScript scriptChange;
...
void CWallet::ReserveKeyFromKeyPool(int64_t& nIndex, CKeyPool& keypool)
{
    ...
    keypool.vchPubKey = CPubKey();
    {
        ...
        LogPrint("net","keypool reserve %d\n", nIndex);
    }
}
