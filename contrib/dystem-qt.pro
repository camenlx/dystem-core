...
RESOURCES += src/qt/dystem.qrc src/qt/dystem_locale.qrc

TRANSLATIONS += src/qt/locale/dystem_bg.ts \
                src/qt/locale/dystem_de.ts \
                src/qt/locale/dystem_en.ts \
                src/qt/locale/dystem_es.ts \
                src/qt/locale/dystem_fi.ts \
                src/qt/locale/dystem_fr.ts \
                src/qt/locale/dystem_it.ts \
                src/qt/locale/dystem_ja.ts \
                src/qt/locale/dystem_pl.ts \
                src/qt/locale/dystem_pt.ts \
                src/qt/locale/dystem_ru.ts \
                src/qt/locale/dystem_sk.ts \
                src/qt/locale/dystem_sv.ts \
                src/qt/locale/dystem_vi.ts \
                src/qt/locale/dystem_zh_CN.ts \
                src/qt/locale/dystem_zh_TW.ts
