...
pkgdatadir = $(datadir)/dystem
pkgincludedir = $(includedir)/dystem
pkglibdir = $(libdir)/dystem
pkglibexecdir = $(libexecdir)/dystem
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = x86_64-apple-darwin17.6.0
host_triplet = x86_64-apple-darwin17.6.0
subdir = .
...
CONFIG_HEADER = $(top_builddir)/src/config/dystem-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/dystem-config.h.in \
...
ACLOCAL = ${SHELL} /Users/jameswoodbridge/code/Crypto/dystem-core/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /Users/jameswoodbridge/code/Crypto/dystem-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/jameswoodbridge/code/Crypto/dystem-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/jameswoodbridge/code/Crypto/dystem-core/build-aux/missing automake-1.16
AWK = awk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = dystem-cli
BITCOIN_DAEMON_NAME = dystemd
BITCOIN_GUI_NAME = dystem-qt
BITCOIN_TX_NAME = dystem-tx
...
EVENT_PTHREADS_LIBS = -L/usr/local/Cellar/libevent/2.1.8/lib -levent_pthreads -levent
EXEEXT = 
...
LIPO = lipo
LN_S = ln -s
LRELEASE = /usr/local/Cellar/qt/5.10.1/bin/lrelease
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
LUPDATE = /usr/local/Cellar/qt/5.10.1/bin/lupdate
MAINT = 
MAKEINFO = ${SHELL} /Users/jameswoodbridge/code/Crypto/dystem-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = :
PACKAGE = dystem
PACKAGE_BUGREPORT = www.dystem.org
PACKAGE_NAME = Dystem Core
PACKAGE_STRING = Dystem Core 1.0.5
PACKAGE_TARNAME = dystem
PACKAGE_URL = 
...
QT4_CFLAGS = 
QT4_LIBS = 
QT5_CFLAGS = -DQT_NETWORK_LIB -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB -I/usr/local/Cellar/qt/5.10.1/include/QtNetwork -I/usr/local/Cellar/qt/5.10.1/include -I/usr/local/Cellar/qt/5.10.1/include/QtWidgets -I/usr/local/Cellar/qt/5.10.1/include -I/usr/local/Cellar/qt/5.10.1/include/QtGui -I/usr/local/Cellar/qt/5.10.1/include -I/usr/local/Cellar/qt/5.10.1/include/QtCore -I/usr/local/Cellar/qt/5.10.1/include
QT5_LIBS = -F/usr/local/Cellar/qt/5.10.1/lib -framework QtNetwork -F/usr/local/Cellar/qt/5.10.1/lib -framework QtWidgets -F/usr/local/Cellar/qt/5.10.1/lib -framework QtGui -F/usr/local/Cellar/qt/5.10.1/lib -framework QtCore
QTPLATFORM_CFLAGS = 
QTPLATFORM_LIBS = 
QTPRINT_CFLAGS = 
QTPRINT_LIBS = 
...
RCC = /usr/local/Cellar/qt/5.10.1/bin/rcc
READELF = 
RELDFLAGS = 
...
abs_builddir = /Users/jameswoodbridge/code/Crypto/dystem-core
abs_srcdir = /Users/jameswoodbridge/code/Crypto/dystem-core
abs_top_builddir = /Users/jameswoodbridge/code/Crypto/dystem-core
abs_top_srcdir = /Users/jameswoodbridge/code/Crypto/dystem-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/jameswoodbridge/code/Crypto/dystem-core/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_dystem_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_dystem_coverage.info test_dystem.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/DYSTEM-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/dystem-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/dystem-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/dystem-config.h
$(top_srcdir)/src/config/dystem-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/dystem-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/DYSTEM-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/DYSTEM-Qt
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/DYSTEM-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_dystem.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_dystem -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_dystem_filtered.info: test_dystem.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_dystem_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_dystem_coverage.info: baseline_filtered_combined.info test_dystem_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_dystem_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_dystem_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_dystem_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_dystem.coverage/.dirstamp:  test_dystem_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_dystem.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_dystem.coverage/ total.coverage/ $(OSX_APP)
